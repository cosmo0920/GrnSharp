...
public partial class NativeConstants {
  ...
  if ((format)->expression) { GRN_OBJ_FIN((ctx), (format)->expression); } 
    ...
    public const string GRN_RECORD_INIT = NativeConstants.GRN_VALUE_FIX_SIZE_INIT;
    ...
    public const string GRN_TIME_SET = NativeConstants.GRN_INT64_SET;
  ...
  grn_bulk_write_from((ctx), (obj), (char *)&_val,
    ...
    public const string GRN_TIME_SET_AT = NativeConstants.GRN_INT64_SET_AT;
    ...
    public const string GRN_TIME_VALUE = NativeConstants.GRN_INT64_VALUE;
    ...
    public const string GRN_TIME_VALUE_AT = NativeConstants.GRN_INT64_VALUE_AT;
    ...
    public const string GRN_TIME_PUT = NativeConstants.GRN_INT64_PUT;
